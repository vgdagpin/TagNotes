...
const TnSectionMarkdown = ({
	...
	return (
		<div
			ref={rootRef}
			className="note-section border border-border rounded-md p-2 transition-colors min-w-0 w-full focus:outline-none focus:ring-1 focus:ring-accent cursor-default"
