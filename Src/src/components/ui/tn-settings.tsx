		...
		<div className="h-full flex flex-col min-w-0 w-full">
			...
			<div className="flex-1 p-4 overflow-y-auto space-y-6 min-w-0 w-full">
				...
				<div className="space-y-4">
					...
					<div className="space-y-2">
						...
						<p className="text-xs text-muted-foreground">
							Select a directory to store your notes locally. This uses the File
							System Access API in your browser.
						</p>
					</div>
				</div>
				...
				<div className="pt-4 text-xs text-muted-foreground space-y-2">
					<p>
						The browser File System Access API does not expose the full absolute path
						for privacy. Only the selected folder name is shown.
					</p>
					<p>
						If you need to remember the full path, rename the folder in your OS or add
						it to bookmarks.
					</p>
				</div>
			</div>
